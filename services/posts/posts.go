...
type PostsService interface {
	...
	UpdatePost(ctx context.Context, id int, post models.Post) (models.Post, error)
...
func (s *Posts) UpdatePost(ctx context.Context, id int, post models.Post) (models.Post, error) {
